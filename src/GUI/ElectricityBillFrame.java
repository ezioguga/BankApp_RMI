...
public class ElectricityBillFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ElectricityBillFrame frame = new ElectricityBillFrame();
	...
	public ElectricityBillFrame() {
		...
		button.setBounds(29, 287, 159, 72);
